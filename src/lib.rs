...
pub const MEMORY_SIZE: usize = 0x41B9; // ?
/// Memory total range
pub const MEMORY: RangeInclusive<usize> = 0..=0x41B8;
/// ROM memory range
pub const ROM: RangeInclusive<usize> = 0..=0x1FFF;
/// RAM memory range
pub const RAM: RangeInclusive<usize> = 0x2000..=0x41B8;
...
pub const FRAMEBUFFER: RangeInclusive<usize> = 0x2400..=0x41B8;
